...
describe('game-store-stream', () => {
  ...
  describe('loadCultivator', () => {
    ...
    it('should fetch and update state on success', async () => {
      mockFetch.mockResolvedValueOnce({
        ...
        json: async () => ({
          cultivator: {
            id: 'c1', name: '测试', realm: '凡人', age: 10,
            gold: 100, stamina: 20, location: 'home',
          },
        }),
      });
  ...
  describe('performAction', () => {
    ...
    it('should set loading state and call fetch', async () => {
      ...
      useGameStore.setState({ cultivator: { id: 'c1', name: '测试', realm: '凡人', age: 10, gold: 100, stamina: 20, location: 'home', realmLevel: 0, cultivationExp: 0, totalExp: 0, health: 100, mindDemon: 0, spiritualRoot: 'gold', worldId: 'earth', title: null, breakthroughCount: 0, maxAge: null, bonusAge: 0, reincarnationCount: 0, talents: null, injuryDebuff: 0, attributes: null, attributeExp: null, subjectExp: null, storyEntries: null, inventory: null, npcRelations: null, unlockedLocations: null, occupation: null, gender: null, schoolRank: 0, clique: null, examResults: null, milestones: null, pet: null, classEnroll: null, savings: null, arcadeStats: null, readingLog: null, breakthroughBuff: 0 } as any });
