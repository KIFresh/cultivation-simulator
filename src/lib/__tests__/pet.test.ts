...
describe('pet', () => {
  describe('parsePet', () => {
    ...
    it('should parse valid pet JSON', () => {
      const raw = JSON.stringify({ type: 'cat', name: '橘灯', intimacy: 50, petAge: 2, acquiredAge: 6 });
  ...
  describe('getPetAcquireInfo', () => {
    it('should return info for known pet type', () => {
      const info = getPetAcquireInfo({ type: 'cat', name: '橘灯', intimacy: 50, petAge: 0, acquiredAge: 6 });
