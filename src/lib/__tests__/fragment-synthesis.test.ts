...
describe('功法残页合成', () => {
  it('不足10张不能合成', () => {
    const inventory = [
      { itemId: 'fragment_basic_breathing', quantity: 5, equipped: false },
    ];
  ...
  it('20张可以合成2次', () => {
    const inventory = [
      { itemId: 'fragment_basic_breathing', quantity: 20, equipped: false },
    ];
    const result = checkFragmentSynthesis(inventory, []);
  ...
  it('合成后消耗残页', () => {
    const inventory = [
      { itemId: 'fragment_basic_breathing', quantity: 15, equipped: false },
    ];
    const result = checkFragmentSynthesis(inventory, []);
