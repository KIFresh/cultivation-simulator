...
const DOMAINS = [
  "经史", "药理", "兵法", "符箓", "阵法", "炼器", "丹道",
  "剑修", "体修", "御兽", "琴道", "棋道", "书画", "天文", "地理",
];

function makeBooks(): Book[] {
  const titles = [
    "吐纳初解", "灵草图谱", "百战策", "符箓入门", "小周天阵", "锻器要术",
    "丹方集注", "基础剑诀", "炼体真言", "御兽手札", "琴心诀", "弈理",
    "丹青录", "观星术", "堪舆考", "内景经", "外丹别传", "御风篇",
    "草木辨", "战阵图", "符兵术", "连环阵", "铸剑录", "养丹法",
    "剑意说", "金刚身", "驯兽经", "清音谱", "棋势", "写神诀",
    "星象辨", "地脉论",
  ];
...
export function readBook(input: {
  id: string;
  age: number;
  log: ReadingLog;
}): ReadingResult {
