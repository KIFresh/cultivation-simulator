...
export const MORTAL_EVENTS: MortalEvent[] = [
  {
    ...
    text: "巷口有只瘦猫朝你喵喵叫。",
    options: [
      { effects: { charm: 1 }, narrative: "你蹲下喂了它一口饼干，猫咪蹭了蹭你的手。" },
      { effects: { mind: -1 }, narrative: "你嫌它吵，绕道走了，心里有点烦躁。" },
    ],
  },
  {
    id: "m_lucky_coin",
    text: "路边水洼里闪着一枚硬币。",
    options: [
      { effects: { luck: 1 }, gold: 5, narrative: "你捡起硬币，今天似乎顺风顺水。" },
  ...
  },
  {
    ...
    text: "邻家小孩拉你比弹珠。",
    options: [
      { effects: { insight: 1 }, narrative: "你教他瞄准的诀窍，自己也悟了点门道。" },
      { effects: { charm: -1 }, narrative: "你赢了所有弹珠，他哭着跑了。" },
    ],
  },
  {
    id: "m_rain_book",
    text: "下雨天，书摊在清仓。",
    options: [
      { effects: { insight: 1 }, gold: -3, narrative: "你花零钱淘了本旧书，津津有味。" },
  ...
  },
  {
    ...
    text: "楼下奶奶端来一碗汤。",
    options: [
      { effects: { health: 3, charm: 1 }, narrative: "热汤下肚，浑身舒坦。" },
...
export const DINNER_EVENTS: MortalEvent[] = [
  {
    ...
    text: "饭桌上，父亲夸了你一句。",
    options: [
      { effects: { mind: 1 }, narrative: "你红了脸，心里甜滋滋的。" },
  ...
  },
  {
    ...
    text: "父母为琐事拌嘴。",
    options: [
      { effects: { mind: -1 }, narrative: "你缩了缩脖子，不太自在。" },
      { effects: { insight: 1 }, narrative: "你默默劝开二老，竟有点小大人模样。" },
    ],
  },
  {
    id: "d_new_dish",
    text: "桌上多了道没见过的菜。",
    options: [
      { effects: { charm: 1 }, gold: -2, narrative: "你抢着尝鲜，还夸了厨艺。" },
...
export const FESTIVAL_EVENTS: MortalEvent[] = [
  {
    ...
    text: "新年，长辈塞来红包。",
    options: [
      { effects: { luck: 1 }, gold: 20, narrative: "红包厚实，你乐得合不拢嘴。" },
      { effects: { mind: 1 }, narrative: "你乖巧地拜了年，得了句夸奖。" },
    ],
  },
  {
    id: "f_lantern",
    text: "元宵灯会，人山人海。",
    options: [
      { effects: { charm: 1, insight: 1 }, narrative: "你猜中灯谜，赢得一阵喝彩。" },
      { effects: { luck: -1 }, narrative: "你挤丢了鞋，悻悻而归。" },
    ],
  },
];
...
export const EXAM_EVENTS: MortalEvent[] = [
  {
    ...
    ageBand: "7-12",
    options: [
      { effects: { insight: 1, mind: 1 }, narrative: "你考了双百，老师当众表扬。" },
      { effects: { mind: -1 }, narrative: "你马虎错了几题，被叫了家长。" },
    ],
  },
  {
  ...
  },
  {
    ...
    ageBand: "13-15",
    options: [
      { effects: { insight: 2 }, narrative: "你冲进年级前十，意气风发。" },
      { effects: { mind: -1, insight: 0 }, narrative: "名次下滑，你暗暗较劲。" },
    ],
  },
  {
    id: "e_junior_parents",
