...
const h = vi.hoisted(() => ({
  /** 模拟数据库中的旧家庭（赵文、林建国） */
  existingFamily: [
    { id: 'old-1', relation: '父亲', name: '赵文', age: 35, alive: true, intimacy: 50, occupation: null },
    { id: 'old-2', relation: '母亲', name: '林建国', age: 32, alive: true, intimacy: 50, occupation: null },
  ],
  cultivator: {
    id: 'c1', userId: 'user1', name: '陈念安', realm: '炼气期', realmLevel: 3,
  ...
  /** 出生叙事返回的新家庭（陈建国、刘秀梅） */
  birthNarrative: {
    type: 'BIRTH', title: '麟儿降世', narrative: '寒冬腊月，父亲陈建国在产房外焦急等待，母亲刘秀梅躺在床上。给孩子取名陈念安。',
