...
const LIFE_ACTIVITIES = [
  ...
  { href: "/short-video", icon: "📱", name: "短视频奇遇", desc: "指尖滑过，都市修仙的碎片落进心里。" },
  ...
  { href: "/exchange", icon: "🏦", name: "兑换所", desc: "金币与灵石在此桥接，凡人可预存、修士能变现。" },
  { href: "/spirit-pet", icon: "🐾", name: "灵宠洞府", desc: "孵化灵宠蛋，养成战力与采集双加成。" },
  { href: "/secret-realm", icon: "🌀", name: "秘境钥匙", desc: "以灵石灵草为门票，入秘境搏灵草、残页与机缘。" },
];
